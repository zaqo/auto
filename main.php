 ...
 -->
						...
						<button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#collapsibleNavbar">
							...
							<div class="collapse navbar-collapse ml-3" id="collapsibleNavbar">
								<ul class="navbar-nav">
								<!--	<li class="nav-item">
										<a class="dropdown-item nav-link" href="main.php?command=book_km&id='.$id.'" title="mileage">Пробег</a>
									</li>
									<li class="nav-item">
										<a class="dropdown-item " href="main.php?command=report_km&id='.$id.'" title="mileage">Отчет по пробегу</a>
									</li>
									<li class="nav-item">
										<a class="dropdown-item " href="main.php?command=book_gas&id='.$id.'" title="fuel">Топливо</a>
									</li>
